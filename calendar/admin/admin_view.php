...
<div id="main" class="container">
  <header><h2 style="text-align:center;">Manage an Event</h2></header>
...
?>
	  <header style="text-align:center;"><h4><?php echo date_format($dDate,"jS \of M Y"); ?></h4></header>
    ...
    <div class="row">
      ...
      <div class="-3u 6u 12u(medium)" style="padding-bottom:10px;">
        <h5>Allow Registration:&nbsp;&nbsp;<a class="" href="view_registration.php?eid=<?php echo $schedID; ?>">View Registrations (<?php echo $total; ?>)</a></h5>
        <?php if ($blnAllowReg) { ?>
      ...
      <div class="-3u 6u 12u(medium)" style="padding-bottom:10px;">
        ...
        <textarea id="comments" name="comments" cols="50" rows="10"><?php echo $comments; ?></textarea>
      </div>
